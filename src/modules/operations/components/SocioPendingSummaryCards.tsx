...
import { useSocioPendingSummary } from '@/modules/operations/hooks/use-socio-pending-summary';
...
export function SocioPendingSummaryCards() {
  ...
  return (
    <DashboardSection
      ...
      description="Accesos directos a lo que necesita tu atención esta semana."
    ...
    >
      ...
      />
      <PendingTaskCard
        label="Comisiones pendientes (esta semana)"
