...
export function RegisteredProfitability({ summary, isLoading }: { summary: ExecutiveDashboardSummary; isLoading: boolean }) {
  ...
  return <DashboardSection title="Comisiones registradas" description="Importes de socios comerciales. El sistema no registra todos los costos necesarios para calcular margen neto ni margen de oficina." contentClassName="grid grid-cols-1 gap-3 md:grid-cols-3">
